...
import { IPowerUp, PowerUp1, PowerUp2, PowerUp3 } from 'src/app/game-engine/PickUps/PowerUpsFactory/PowerUps';
import {IHeal,HealMapOne,HealMapTwo,HealMapThree} from 'src/app/game-engine/PickUps/Heals-Factory/Heal';
