...
import { IHeal, HealMapOne, HealMapTwo, HealMapThree } from '../Heals-Factory/Heal';
...
export abstract class PickUpsFactory{
  ...
  public createPowerUp(snake: any, wall: any){return };
  public createHeal(snake: any, wall: any){return };
}
